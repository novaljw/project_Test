...
<script type="text/javascript">
	function check(){
		...
		//form 요소 
// 		var frm  = document.forms[0]; //form 사용
		var frm  = document.frm; //name속성
// 		var from = document.getElementById('frm'); 		//id
...
// 			alert(id);
			...
			if(id.indexOf(" ") != -1){
				//documement.getElementById('result').style.color = 'red';
				...
				// javascript 객체는 있으면 무조건 ture로 판단 합니다.
// 					var obj1 = msg.isc;
